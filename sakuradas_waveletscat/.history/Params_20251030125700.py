...
hdf5_starttime_jst = datetime.datetime(2025, 5, 15, 0, 0, 0)
hdf5_endttime_jst = datetime.datetime(2025, 5, 16, 0, 0, 0)
...
threshold = 30  ### dendrogram cut-off distance