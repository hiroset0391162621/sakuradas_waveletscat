...
if __name__ == "__main__":
    ...
    cluster_and_plot_dendrogram(ustation_plot, copy.deepcopy(Z), threshold, default_color='black', pooling=ppoling, savefig=True, output_dir=output_dir, filename_suffix=date_range_str)
