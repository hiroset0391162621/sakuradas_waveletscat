...
hdf5_starttime_jst = datetime.datetime(2025, 4, 2, 23, 3, 0)
hdf5_endttime_jst = datetime.datetime(2025, 4, 2, 23, 9, 0)
...
used_channel_list = [str(_).zfill(4) for _ in range(3000, 3005, 5)]   
